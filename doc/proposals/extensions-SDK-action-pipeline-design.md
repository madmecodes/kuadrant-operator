...
- [x] [Define action types and `Pipeline` interface](https://github.com/Kuadrant/kuadrant-operator/issues/1901)
  - [x] Unit tests
- [x] [Add `PipelineOnRequest` and `PipelineOnResponse` RPCs to gRPC proto](https://github.com/Kuadrant/kuadrant-operator/issues/1902)
  - [x] Unit tests
- [x] [Implement `PipelineActionStore`](https://github.com/Kuadrant/kuadrant-operator/issues/1903)
  - [x] Unit tests
- [x] [Implement server-side pipeline handlers with CEL intention validation](https://github.com/Kuadrant/kuadrant-operator/issues/1904)
  - [x] Unit tests
  - [ ] Integration tests
