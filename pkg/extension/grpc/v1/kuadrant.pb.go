...
type RequestActionEntry struct {
	...
	Predicates    []string               `protobuf:"bytes,2,rep,name=predicates,proto3" json:"predicates,omitempty"` // CEL predicates — if any is false, skip this action
...
func (x *RequestActionEntry) GetPredicates() []string {
	if x != nil {
		return x.Predicates
	}
	return nil
...
func (x *ResponseActionEntry) GetPredicates() []string {
	if x != nil {
		return x.Predicates
	}
	return nil
...
// PipelineOnRequestRequest registers request-phase actions for a policy.
type PipelineOnRequestRequest struct {
	state   protoimpl.MessageState `protogen:"open.v1"`
	Policy  *Policy                `protobuf:"bytes,1,opt,name=policy,proto3" json:"policy,omitempty"`
	Actions []*RequestActionEntry  `protobuf:"bytes,2,rep,name=actions,proto3" json:"actions,omitempty"`
	// When true, clear existing request-phase actions for this policy before
	// appending. Used by PipelineImpl to ensure the first call in a reconcile
	// replaces stale actions from prior reconciles.
	Reset_        bool `protobuf:"varint,3,opt,name=reset,proto3" json:"reset,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PipelineOnRequestRequest) Reset() {
	*x = PipelineOnRequestRequest{}
	mi := &file_v1_kuadrant_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PipelineOnRequestRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PipelineOnRequestRequest) ProtoMessage() {}

func (x *PipelineOnRequestRequest) ProtoReflect() protoreflect.Message {
	mi := &file_v1_kuadrant_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PipelineOnRequestRequest.ProtoReflect.Descriptor instead.
func (*PipelineOnRequestRequest) Descriptor() ([]byte, []int) {
	return file_v1_kuadrant_proto_rawDescGZIP(), []int{13}
}

func (x *PipelineOnRequestRequest) GetPolicy() *Policy {
	if x != nil {
		return x.Policy
	}
	return nil
...
func (x *PipelineOnRequestRequest) GetActions() []*RequestActionEntry {
	if x != nil {
		return x.Actions
	}
	return nil
...
func (x *PipelineOnRequestRequest) GetReset_() bool {
	if x != nil {
		return x.Reset_
	}
	return false
...
// PipelineOnResponseRequest registers response-phase actions for a policy.
type PipelineOnResponseRequest struct {
	state   protoimpl.MessageState `protogen:"open.v1"`
	Policy  *Policy                `protobuf:"bytes,1,opt,name=policy,proto3" json:"policy,omitempty"`
	Actions []*ResponseActionEntry `protobuf:"bytes,2,rep,name=actions,proto3" json:"actions,omitempty"`
	// When true, clear existing response-phase actions for this policy before
	// appending.
	Reset_        bool `protobuf:"varint,3,opt,name=reset,proto3" json:"reset,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *PipelineOnResponseRequest) Reset() {
	*x = PipelineOnResponseRequest{}
	mi := &file_v1_kuadrant_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PipelineOnResponseRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PipelineOnResponseRequest) ProtoMessage() {}

func (x *PipelineOnResponseRequest) ProtoReflect() protoreflect.Message {
	mi := &file_v1_kuadrant_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PipelineOnResponseRequest.ProtoReflect.Descriptor instead.
func (*PipelineOnResponseRequest) Descriptor() ([]byte, []int) {
	return file_v1_kuadrant_proto_rawDescGZIP(), []int{14}
}

func (x *PipelineOnResponseRequest) GetPolicy() *Policy {
	if x != nil {
		return x.Policy
	}
	return nil
...
func (x *PipelineOnResponseRequest) GetActions() []*ResponseActionEntry {
	if x != nil {
		return x.Actions
	}
	return nil
...
func (x *PipelineOnResponseRequest) GetReset_() bool {
	if x != nil {
		return x.Reset_
	}
	return false
...
const file_v1_kuadrant_proto_rawDesc = "" +
	...
	"\x10message_template\x18\x06 \x01(\tR\x0fmessageTemplate\"\xb6\x01\n" +
	...
	"\x03var\x18\x05 \x01(\tR\x03var\"\xc1\x01\n" +
	...
	"\x11new_response_code\x18\x04 \x01(\x05R\x0fnewResponseCode\"\x98\x01\n" +
	"\x18PipelineOnRequestRequest\x12+\n" +
	"\x06policy\x18\x01 \x01(\v2\x13.kuadrant.v1.PolicyR\x06policy\x129\n" +
	"\aactions\x18\x02 \x03(\v2\x1f.kuadrant.v1.RequestActionEntryR\aactions\x12\x14\n" +
	"\x05reset\x18\x03 \x01(\bR\x05reset\"\x9a\x01\n" +
	"\x19PipelineOnResponseRequest\x12+\n" +
	"\x06policy\x18\x01 \x01(\v2\x13.kuadrant.v1.PolicyR\x06policy\x12:\n" +
	"\aactions\x18\x02 \x03(\v2 .kuadrant.v1.ResponseActionEntryR\aactions\x12\x14\n" +
	"\x05reset\x18\x03 \x01(\bR\x05reset*E\n" +
	"\x06Domain\x12\x16\n" +
	...
	"\x1eACTION_TYPE_WITH_RESPONSE_CODE\x10\x042\x99\x05\n" +
	...
	"\x14RegisterActionMethod\x12(.kuadrant.v1.RegisterActionMethodRequest\x1a\x16.google.protobuf.Empty\"\x00\x12T\n" +
	"\x11PipelineOnRequest\x12%.kuadrant.v1.PipelineOnRequestRequest\x1a\x16.google.protobuf.Empty\"\x00\x12V\n" +
	"\x12PipelineOnResponse\x12&.kuadrant.v1.PipelineOnResponseRequest\x1a\x16.google.protobuf.Empty\"\x00B\x05Z\x03/v1b\x06proto3"
...
var file_v1_kuadrant_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_v1_kuadrant_proto_goTypes = []any{
	...
	(*PipelineOnRequestRequest)(nil),    // 15: kuadrant.v1.PipelineOnRequestRequest
	(*PipelineOnResponseRequest)(nil),   // 16: kuadrant.v1.PipelineOnResponseRequest
	(*timestamp.Timestamp)(nil),         // 17: google.protobuf.Timestamp
	(*Policy)(nil),                      // 18: kuadrant.v1.Policy
	(*v1alpha1.Value)(nil),              // 19: google.api.expr.v1alpha1.Value
	(*status.Status)(nil),               // 20: google.rpc.Status
	(*Metadata)(nil),                    // 21: kuadrant.v1.Metadata
	(*empty.Empty)(nil),                 // 22: google.protobuf.Empty
}
var file_v1_kuadrant_proto_depIdxs = []int32{
	17, // 0: kuadrant.v1.PingRequest.out:type_name -> google.protobuf.Timestamp
	17, // 1: kuadrant.v1.PongResponse.in:type_name -> google.protobuf.Timestamp
	18, // 2: kuadrant.v1.ResolveRequest.policy:type_name -> kuadrant.v1.Policy
	19, // 3: kuadrant.v1.ResolveResponse.cel_result:type_name -> google.api.expr.v1alpha1.Value
	8,  // 4: kuadrant.v1.SubscribeResponse.event:type_name -> kuadrant.v1.Event
	20, // 5: kuadrant.v1.SubscribeResponse.error:type_name -> google.rpc.Status
	21, // 6: kuadrant.v1.Event.metadata:type_name -> kuadrant.v1.Metadata
	18, // 7: kuadrant.v1.RegisterMutatorRequest.policy:type_name -> kuadrant.v1.Policy
	0,  // 8: kuadrant.v1.RegisterMutatorRequest.domain:type_name -> kuadrant.v1.Domain
	18, // 9: kuadrant.v1.ClearPolicyRequest.policy:type_name -> kuadrant.v1.Policy
	18, // 10: kuadrant.v1.RegisterActionMethodRequest.policy:type_name -> kuadrant.v1.Policy
	...
	18, // 13: kuadrant.v1.PipelineOnRequestRequest.policy:type_name -> kuadrant.v1.Policy
	13, // 14: kuadrant.v1.PipelineOnRequestRequest.actions:type_name -> kuadrant.v1.RequestActionEntry
	18, // 15: kuadrant.v1.PipelineOnResponseRequest.policy:type_name -> kuadrant.v1.Policy
	14, // 16: kuadrant.v1.PipelineOnResponseRequest.actions:type_name -> kuadrant.v1.ResponseActionEntry
	2,  // 17: kuadrant.v1.ExtensionService.Ping:input_type -> kuadrant.v1.PingRequest
	7,  // 18: kuadrant.v1.ExtensionService.Subscribe:input_type -> kuadrant.v1.SubscribeRequest
	4,  // 19: kuadrant.v1.ExtensionService.Resolve:input_type -> kuadrant.v1.ResolveRequest
	9,  // 20: kuadrant.v1.ExtensionService.RegisterMutator:input_type -> kuadrant.v1.RegisterMutatorRequest
	10, // 21: kuadrant.v1.ExtensionService.ClearPolicy:input_type -> kuadrant.v1.ClearPolicyRequest
	12, // 22: kuadrant.v1.ExtensionService.RegisterActionMethod:input_type -> kuadrant.v1.RegisterActionMethodRequest
	15, // 23: kuadrant.v1.ExtensionService.PipelineOnRequest:input_type -> kuadrant.v1.PipelineOnRequestRequest
	16, // 24: kuadrant.v1.ExtensionService.PipelineOnResponse:input_type -> kuadrant.v1.PipelineOnResponseRequest
	3,  // 25: kuadrant.v1.ExtensionService.Ping:output_type -> kuadrant.v1.PongResponse
	6,  // 26: kuadrant.v1.ExtensionService.Subscribe:output_type -> kuadrant.v1.SubscribeResponse
	5,  // 27: kuadrant.v1.ExtensionService.Resolve:output_type -> kuadrant.v1.ResolveResponse
	22, // 28: kuadrant.v1.ExtensionService.RegisterMutator:output_type -> google.protobuf.Empty
	11, // 29: kuadrant.v1.ExtensionService.ClearPolicy:output_type -> kuadrant.v1.ClearPolicyResponse
	22, // 30: kuadrant.v1.ExtensionService.RegisterActionMethod:output_type -> google.protobuf.Empty
	22, // 31: kuadrant.v1.ExtensionService.PipelineOnRequest:output_type -> google.protobuf.Empty
	22, // 32: kuadrant.v1.ExtensionService.PipelineOnResponse:output_type -> google.protobuf.Empty
